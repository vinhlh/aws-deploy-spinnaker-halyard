...
# Configure Jenkins
echo ${JENKIN_1_PASSWORD} | hal --color false config ci jenkins master add ${JENKIN_1_MAME} \
    --address ${JENKIN_1_ADDRESS} \
    --username ${JENKIN_1_USERNAME} \
    --password

echo ${JENKIN_2_PASSWORD} | hal --color false config ci jenkins master add ${JENKIN_2_MAME} \
